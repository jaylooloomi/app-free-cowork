const zhTW = {
  ...
  settingsCaptureHotkey: "截圖快捷鍵",
  settingsCaptureHotkeyPlaceholder: "Alt+K",
  settingsCaptureHotkeyHint: "面板開著時按這組鍵啟動框選截圖。格式如 Alt+K、Ctrl+Shift+S。",
  settingsScheduleHotkey: "排程快捷鍵",
  settingsScheduleHotkeyPlaceholder: "Alt+L",
  settingsScheduleHotkeyHint: "面板開著時按這組鍵切換排程模式。格式如 Alt+L、Ctrl+Shift+L。",
  settingsModel: "模型",
  ...
  completedDetailTip: "看執行細節",
  completedFailed: "失敗",
  sectionActive: "排隊 / 執行中",
  ...
  // ---------- 排程 ----------
  schedTitle: "排程",
  schedTooltip: "排程(週期性執行)",
  schedKindMinutes: "每 N 分鐘",
  schedKindHours: "每 N 小時",
  schedKindDaily: "每天",
  schedKindWeekly: "每週",
  schedUnitMin: "分鐘",
  schedUnitHour: "小時",
  ...
  schedWeekdayPrefix: "週",
  schedEveryMin: (n: number) => `每 ${n} 分鐘`,
  schedEveryHour: (n: number) => `每 ${n} 小時`,
  schedDailyAt: (hm: string) => `每天 ${hm}`,
  schedWeeklyAt: (wd: string, hm: string) => `每週${wd} ${hm}`,
};
...
const en = {
  ...
  settingsCaptureHotkey: "Screenshot shortcut",
  settingsCaptureHotkeyPlaceholder: "Alt+K",
  settingsCaptureHotkeyHint: "Press this combo while the palette is open to start a region snip. Format like Alt+K or Ctrl+Shift+S.",
  settingsScheduleHotkey: "Schedule shortcut",
  settingsScheduleHotkeyPlaceholder: "Alt+L",
  settingsScheduleHotkeyHint: "Press this combo while the palette is open to toggle schedule mode. Format like Alt+L or Ctrl+Shift+L.",
  settingsModel: "Model",
  ...
  completedDetailTip: "View details",
  ...
  // ---------- schedule ----------
  schedTitle: "Schedule",
  schedTooltip: "Schedule (recurring)",
  schedKindMinutes: "Every N minutes",
  schedKindHours: "Every N hours",
  schedKindDaily: "Daily",
  schedKindWeekly: "Weekly",
  schedUnitMin: "min",
  schedUnitHour: "hours",
  schedRunNow: "Run once now",
  schedSection: "Scheduled",
  schedPause: "Pause",
  schedEnable: "Enable",
  schedDeleteTip: "Delete schedule",
  scheduledToast: "Scheduled ✓",
  schedWeekdays: ["Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun"],
  schedWeekdayPrefix: "",
  schedEveryMin: (n: number) => `Every ${n} min`,
  schedEveryHour: (n: number) => `Every ${n} hours`,
  schedDailyAt: (hm: string) => `Daily ${hm}`,
  schedWeeklyAt: (wd: string, hm: string) => `${wd} ${hm} weekly`,
} satisfies Strings;
